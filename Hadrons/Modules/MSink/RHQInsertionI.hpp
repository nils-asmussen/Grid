...
#ifndef Hadrons_MSink_RHQInsertionI_hpp_
#define Hadrons_MSink_RHQInsertionI_hpp_
...
MODULE_REGISTER_TMP(RHQInsertionI, ARG(TRHQInsertionI<FIMPL, GIMPL>), MSink);
...
#endif // Hadrons_MSink_RHQInsertionI_hpp_
